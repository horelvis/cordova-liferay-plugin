...
var app = {
    ...
    login: function(){
        ...
        var errorElement = parentElement.querySelector('.errorConnecting');
        ...
        Liferay.connect(function (data){
            console.log("success "+data);
            Liferay.execute(function (dat){
            
                console.log(dat);
            
            }, null, 'com.liferay.portal.model.Country', 'getCountryByA2', ['af']);
            var parentElement = document.getElementById('deviceready');
            var connectingElement = parentElement.querySelector('.connecting');
            var connectedElement = parentElement.querySelector('.connected');
        ...
        }, 'http://192.168.0.160:8080', 'test@liferay.com', 'test'  );
    },
};
